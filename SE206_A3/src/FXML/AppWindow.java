...
public enum AppWindow {
	...
	MainMenu("MainMenu"), CreateMenu("CreateMenu"), CreationName("CreationName"), SearchError("SearchError"), SelectSentences("SelectSentences"), AudioFiles("AudioFiles"), AudioName("AudioName"), MergeName("MergeName"), SelectImages("SelectImages"), OrderImages("OrderImages"), ViewMenu("ViewMenu");
