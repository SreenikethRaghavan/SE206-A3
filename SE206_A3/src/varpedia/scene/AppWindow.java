...
public enum AppWindow {
	...
	LearnMenu("LearnMenu"), Memory("Memory"), ComingSoon("ComingSoon");
	...
	public void setScene(ActionEvent e) throws IOException {
		Parent sceneParent = FXMLLoader.load(getClass().getResource("/varpedia/FXML/" + fileName + ".fxml"));
